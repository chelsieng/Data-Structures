...
public class MagicBoard_Ver3 {
    // Tail Recursive method
    public static boolean MagicBoard(Queue<Pair<Integer, Integer>> queue, int[][] board) {
    ...
    public static void main(String[] args) {
        try {
            PrintWriter writer = new PrintWriter(new FileOutputStream("A2/testLog_ver3.txt", true));
            // Welcome Message
            System.out.println(" ------------------------------ ");
